...
import DoctersSection from "./DoctorsProfile";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex space-x-8">
              <a
                href="#home"
                className="text-gray-700 hover:text-sky-600 px-3 py-2"
              >
                Home
              </a>
              <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 ml-6 mt-10">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Advanced Hospital Management Made Simple
            </h1>
            <p className="text-xl mb-8 text-sky-100 ">
              Streamline your healthcare operations with our comprehensive
              solution for patient records, appointments, billing and more.
            </p>
            <div className="flex space-x-4">
              <Link to="/register">
                <button className="bg-white text-sky-700 px-6 py-3 rounded-md font-medium hover:bg-sky-50 transition">
                  Get Started
                </button>
              </Link>
            </div>
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our system provides all the tools you need to efficiently manage
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Complete patient records, medical history, and treatment tracking
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Streamlined scheduling with automated reminders and real-time
              availability.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Integrated billing system with insurance claims processing and
              payment tracking.
            </p>
          </div>
        </div>
      ...
      <div id="contact" className="bg-sky-700 text-white scroll-mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-xl text-sky-100 mb-8 max-w-3xl mx-auto">
            Join thousands of healthcare providers who trust our system for
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Advanced hospital management solutions for healthcare providers
                of all sizes.
              </p>
            </div>
            <div>
