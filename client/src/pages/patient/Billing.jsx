  ...
  return (
    <div className="container mx-auto mt-4">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-sky-700 text-3xl">Payment History</h1>
        <button
          ...
          <table className="min-w-full bg-white border border-gray-300">
            <thead className="bg-sky-700 text-white">
              <tr>
                ...
                <th className="hidden md:table-cell py-2 px-4 border">Payment Method</th>
                <th className="hidden md:table-cell py-2 px-4 border">Status</th>
