...
//               <a href="#" className="text-gray-700 hover:text-blue-600 px-3 py-2">Services</a>
//               <a href="#" className="text-gray-700 hover:text-blue-600 px-3 py-2">Doctors</a>
//               <a href="#" className="text-gray-700 hover:text-blue-600 px-3 py-2">Contact</a>
//             </div>
//             <div className="flex items-center">
//               <button className="border border-blue-600 text-blue-600 px-4 py-2 rounded-md mr-4 hover:bg-blue-50 transition">Login</button>
...
//             <p className="text-xl mb-8 text-blue-100">Streamline your healthcare operations with our comprehensive solution for patient records, appointments, billing and more.</p>
//             <div className="flex space-x-4">
//               <button className="bg-white text-blue-700 px-6 py-3 rounded-md font-medium hover:bg-blue-50 transition">Get Started</button>
//               <button className="border-2 border-white text-white px-6 py-3 rounded-md font-medium hover:bg-blue-600 transition">Learn More</button>
//             </div>
//           </div>
...
//             <div className="text-blue-600 mb-4 text-4xl">👨‍⚕️</div>
...
//             </div>
//             <div>
//               <div className="text-4xl font-bold text-blue-700 mb-2">1M+</div>
...
//           <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">Join thousands of healthcare providers who trust our system for their daily operations.</p>
//           <button className="bg-white text-blue-700 px-8 py-3 rounded-md font-medium hover:bg-blue-50 transition text-lg">Request a Demo</button>
//         </div>
//       </div>
